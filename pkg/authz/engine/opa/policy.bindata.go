...
func policyAuthzRego() (*asset, error) {
	...
	info := bindataFileInfo{name: "policy/authz.rego", size: 2226, mode: os.FileMode(0644), modTime: time.Unix(1734146483, 0)}
...
func policyCommonRego() (*asset, error) {
	...
	info := bindataFileInfo{name: "policy/common.rego", size: 2020, mode: os.FileMode(0644), modTime: time.Unix(1734146483, 0)}
...
func policyIntrospectionRego() (*asset, error) {
	...
	info := bindataFileInfo{name: "policy/introspection.rego", size: 1864, mode: os.FileMode(0644), modTime: time.Unix(1734146483, 0)}
